...
function GenerateTestData(cr)
	...
	fig = imshow(frame1);
	saveas(fig, ['shotPut_recon_', num2str(cr)], 'eps');
	fig = imshow(frame2);
	saveas(fig, ['shotPut_base_', num2str(cr)], 'eps');
	...
	frame2 = im2uint8(frame2);
	fig = imshow(frame1);
	saveas(fig, ['flute_recon_', num2str(cr)], 'eps');
	fig = imshow(frame2);
	saveas(fig, ['flute_base_', num2str(cr)], 'eps');
...
save(['measurement', num2str(cr), '.mat'], 'psnrAvg', 'ssimAvg', 'elAvg', 'psnrSingle', ...
			'ssimSingle', 'elSingle');
